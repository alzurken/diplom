...
public class NewsVector
{
     ...
     */
    public Map<String, Double> GetSortedFullBasisFreq()
    {
    ...
    public Map<String, Double> BuildFinalVectorForOneNew(News thisNew)
    {
        try
        {
            ...
            IndexWriter w2;
            w2 = new IndexWriter(index2, config2);
    ...
    public Map<String, Double> BuildHopsfieldByVector(Map<String, Double> frequencies, Map<String, Integer> termsInDoc,
            double[][] corMatrix) throws IOException, ParseException, NextCommandException,
            org.apache.lucene.queryparser.classic.ParseException, NeuronNotFound
    {
